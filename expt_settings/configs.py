...
import data_formatters.op
import data_formatters.hypoxemia
...
class ExperimentConfig(object):
  ...
  default_experiments = ['volatility', 'electricity', 'traffic', 'favorita', 'op', 'hypoxemia']
  ...
  def data_csv_path(self):
    csv_map = {
        ...
        'op': '/gpfs/data/fs71801/lkapral66/featureset_20230809_shuffled.parquet',
        'hypoxemia': '/gpfs/data/fs71801/lkapral66/featureset_20230809_shuffled.parquet'
    }
  ...
  def make_data_formatter(self):
    ...
    data_formatter_class = {
        ...
        'op': data_formatters.op.OPFormatter,
        'hypoxemia': data_formatters.hypoxemia.HypoxemiaFormatter
    }
